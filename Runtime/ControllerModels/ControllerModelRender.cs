...
using CENTIS.XRPlatform;
using CENTIS.XRPlatform.ControllerModels;
using CENTIS.XRPlatform.Editor.SceneManagement.Controller;
using UnityEngine;
using UnityEngine.Events;
using UnityEngine.XR;

namespace VRScripts.UI.Device
{
    public class ControllerModelRender : MonoBehaviour
    {
        ...
        {
            CENTIS.XRPlatform.Editor.SceneManagement.Controller.ControllerModel settings =
                handedness == Handedness.Left ? CurrentProfile.LeftHand : CurrentProfile.RightHand;
        ...
        private void InitRenderModel(
            CENTIS.XRPlatform.Editor.SceneManagement.Controller.ControllerModel controllerModel)
        {
